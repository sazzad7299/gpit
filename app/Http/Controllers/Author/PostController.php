...
//            make unipue name for image
           ...
           // $img = Image::make('public/foo.jpg')->resize(320, 240)->insert('public/watermark.png');
            ...
            Image::make($image)->resize(730, 446)->save('uploads/post/'.$imageName);
        ...
        return redirect('/author/deactivepost')->with('successMsg', 'post saved!');
    }
...
//            make unipue name for image
        ...
        return redirect('/author/deactivepost')->with('successMsg', 'post Update!');
