    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="tile">
                ...
                <form action="{{ route('subcategory.update',$subcategories->id) }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                   
                        <div class="form-group">
                            <label class="control-label" for="name_bn">Name <span class="m-l-5 text-danger"> *</span></label>
                            <input class="form-control @error('name') is-invalid @enderror" type="text" name="name_bn" id="name_bn" value="{{ $subcategories->name_bn }}"/>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="exampleFormControlSelect1" name="category_id">
                                ...
                                <option {{ $categories->id == $subcategories->categories->id ? 'selected' : '' }}
                    ...
                    <div class="tile-footer">
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <a class="btn btn-secondary" href="{{ route('subcategory.index') }}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
                    </div>
                </form>
            </div>
        </div>
